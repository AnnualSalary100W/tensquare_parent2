...
@RequestMapping(value = "/{userid}/{friendid}/{x}",method = RequestMethod.PUT)
	public void updatafanscountandfollowcount(@PathVariable String userid,@PathVariable String friendid,@PathVariable int x){
		userService.updatafanscountandfollowcount(x,userid,friendid);
	}
	...
	public Result sengSms(@PathVariable String mobile){
